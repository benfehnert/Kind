import { PHASE_THIRTY_MIN, PHASE_SIXTY_MIN, PHASE_OUTPUT } from "./constants.js";
...
export function analyzeScreenSleep(allEntries, studyMeta, cohortSnapshot = null) {
  const reports = [];
  const baselineEntries = allEntries.filter((e) => e.phase === "BASELINE");
