import { PHASE_REDUCTION, PHASE_SUSTAINED, PHASE_OUTPUT } from "./constants.js";
...
export function analyzeUpfReduction(allEntries, studyMeta, cohortSnapshot = null) {
  const reports = [];
  const baselineEntries = allEntries.filter((e) => e.phase === "BASELINE");
