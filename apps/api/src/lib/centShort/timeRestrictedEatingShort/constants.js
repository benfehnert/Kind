...
export const PHASE_TEN_HOUR = { start: 3, end: 4, key: "INTERVENTION" };
export const PHASE_EIGHT_HOUR = { start: 5, end: 5, key: "OPTIMISE" };
...
export const USER_DISCLAIMER = {
  ...
  body:
    "This reflects your experience over a short six-day alpha exploration — not a medical diagnosis. Sleep, stress, and everyday life shape energy too. Treat these findings as an early personal hint about what may help you, not proof."
};
