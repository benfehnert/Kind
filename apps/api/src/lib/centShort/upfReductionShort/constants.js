...
export const PHASE_REDUCTION = { start: 3, end: 4, key: "INTERVENTION" };
export const PHASE_SUSTAINED = { start: 5, end: 5, key: "OPTIMISE" };
...
export const USER_DISCLAIMER = {
  ...
  body:
    "Diet and mood interact with sleep, stress and social context. This is your personal log over a short six-day alpha exploration — an early hint, not medical advice."
};
