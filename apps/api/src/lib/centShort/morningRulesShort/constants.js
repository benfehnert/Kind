...
export const PHASE_INTERVENTION = { start: 3, end: 5, key: "INTERVENTION" };
export const PHASE_OPTIMISE = { start: 6, end: 7, key: "OPTIMISE" };
export const PHASE_OUTPUT = { start: 8, end: 8, key: "OUTPUT" };
...
export const MIN_ENDOFSTUDY_ACTIVE_DAYS = 3;
export const MIN_RULE_OBSERVATIONS = 1;
...
export const USER_DISCLAIMER = {
  ...
  body:
    "This reflects your experience over a short eight-day alpha exploration — not a medical diagnosis. Sleep, stress, and everyday life shape afternoons too. Treat these findings as an early personal hint about what may help you, not proof."
};
...
export function assignPhase(studyDay) {
  ...
  throw new Error(`study_day out of range 1–8: ${studyDay}`);
}
