...
export function generateFinalReport(allEntries, studyMeta, cohortSnapshot = null) {
  ...
  const generalisabilityNote =
    "These findings reflect your individual response over this short 8-day alpha exploration. With so few days the signal is preliminary and may differ if repeated over a longer period. They are early personal insights, not medical conclusions.";
